  ...
  <div class="login">
    <div class="login-shell">
      <section class="login-brand">
        <span class="brand-pill">企业人事管理平台</span>
        <h1 class="brand-title">企业人事管理系统</h1>
        <p class="brand-desc">
          覆盖员工档案、组织架构、岗位职级与数据字典的一体化人事管理平台
          <br />
          支持员工信息全生命周期管理与细粒度权限控制，助力企业人事数字化、规范化。
        </p>
      ...
      <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="login-form">
        <div class="title-box">
          <div>
            ...
            <p class="subtitle">欢迎使用企业人事管理系统，请登录您的账号。</p>
          </div>
          <lang-select />
        </div>
    ...
    <div class="el-login-footer">
      <span>Copyright © {{ currentYear }} 企业人事管理系统 All Rights Reserved.</span>
    </div>
  </div>
</template>
...
const quickStats = [
  { label: '员工档案集中管理', value: '员工全周期' },
  { label: '组织岗位清晰可控', value: '组织架构管理' },
  { label: '细粒度权限保障', value: '数据安全' }
];
const highlights = ['员工档案管理', '组织架构管理', '岗位职级管理', '数据字典'];
